...
public class A4Q4 {
    ...
    public static void main(String[] args) {
        ...
        ticketsNeeded = Math.ceil(ticketsNeeded);

        // Tells the person the tickets needed
        System.out.println("Acording to my fabulous calculations, the total cost is " + totalCost + 
                ", and you'll need " + ticketsNeeded + " tickets to break even!");
