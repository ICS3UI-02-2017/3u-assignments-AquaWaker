...
public class PongExample extends JComponent implements ActionListener {
    ...
    Font biggerFont = new Font("comic sans", Font.PLAIN, 36);
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("" + score1, WIDTH/2 + 75, 50);
        g.drawString("" + score2, WIDTH/2 - 75, 50);
    ...
    private void movePaddles() {
        ...
        if((paddle1.y + paddle1.height) < 0){
            paddle1.y = HEIGHT;
        } else if (paddle1.y > HEIGHT){
        ...
        if((paddle2.y + paddle2.height) < 0){
            paddle2.y = HEIGHT;
        } else if (paddle2.y > HEIGHT){
            paddle2.y = 0 - paddle2.height;
        }
    }

    private void checkForCollision() {
        // collision with bottem/top
        if(ball.y < 0){
